                                    ...
                                    <tr className="border-b border-slate-100">
                                        ...
                                        <td>
                                            <div className="flex gap-2">
                                                ...
                                                <button className="rounded-lg cursor-pointer bg-blue-100 px-3 py-1 text-sm font-medium text-blue-700">
                                                    <Pencil size={16} className="inline mr-2" />
                                                    Edit
                                                </button>

                                                <button className="rounded-lg cursor-pointer bg-red-100 px-3 py-1 text-sm font-medium text-red-700">
